...
public class ModokModKeyMappings {
    public static final KeyMapping DOWN = new KeyMapping("Modok Fly Down", GLFW.GLFW_KEY_LEFT_CONTROL, "key.categories.misc") {
    ...
    public static final KeyMapping UP = new KeyMapping("Modok Fly Up", GLFW.GLFW_KEY_SPACE, "key.categories.misc") {
        private boolean isDownOld = false;
