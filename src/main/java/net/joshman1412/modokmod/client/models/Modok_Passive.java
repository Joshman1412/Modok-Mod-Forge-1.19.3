...
public class Modok_Passive extends EntityModel<Modok> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Legs = parts.addOrReplaceChild("Legs", CubeListBuilder.create().texOffs(82, 95).addBox(-5.0F, -9.0F, -9.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		...
		.texOffs(0, 38).addBox(3.0F, -9.0F, -11.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
		...
		.texOffs(0, 97).addBox(-10.0F, -15.0F, -2.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
