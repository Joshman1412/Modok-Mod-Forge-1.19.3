...
public class Modok_Aggresive extends EntityModel<Modok> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(0, 0).addBox(-5.0F, -20.0F, -7.0F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(0, 0).addBox(-2.0F, -19.0F, -7.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
