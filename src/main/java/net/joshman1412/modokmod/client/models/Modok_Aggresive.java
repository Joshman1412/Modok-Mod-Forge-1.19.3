...
public class Modok_Aggresive extends EntityModel<Modok> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(ModokMod.MOD_ID, "modok_aggresive"), "main");
	private final ModelPart Legs;
	private final ModelPart Body;
	private final ModelPart Arms;

	public Modok_Aggresive(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Legs = parts.addOrReplaceChild("Legs", CubeListBuilder.create().texOffs(58, 18).addBox(-5.0F, -9.0F, -11.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
		...
		.texOffs(82, 95).addBox(-5.0F, -9.0F, -9.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition Body = parts.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 18).addBox(-10.0F, -9.0F, -8.0F, 20.0F, 2.0F, 18.0F, new CubeDeformation(0.0F))
		...
		.texOffs(0, 68).addBox(-7.0F, -23.0F, -6.0F, 14.0F, 12.0F, 6.0F, new CubeDeformation(0.0F))
		...
		.texOffs(0, 68).addBox(7.0F, -27.0F, 8.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(0, 0).addBox(-1.0F, -17.0F, -7.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(0, 0).addBox(-1.0F, -16.0F, -8.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(0, 0).addBox(-2.0F, -16.0F, -7.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(0, 0).addBox(-1.0F, -18.0F, -7.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(0, 0).addBox(0.0F, -18.0F, -7.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(0, 0).addBox(1.0F, -16.0F, -7.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(0, 0).addBox(1.0F, -19.0F, -7.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(0, 0).addBox(-2.0F, -19.0F, -7.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(0, 0).addBox(2.0F, -20.0F, -7.0F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(0, 0).addBox(-5.0F, -20.0F, -7.0F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition Arms = parts.addOrReplaceChild("Arms", CubeListBuilder.create().texOffs(64, 78).addBox(10.0F, -15.0F, -2.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
		...
		.texOffs(98, 30).addBox(9.0F, -15.0F, -2.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
